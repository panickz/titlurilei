...
var openFB = (function () {
    ...
    function login(scope, success, error) {
        ...
        loginWindow = window.open(FB_LOGIN_URL + '?client_id=' + fbAppId + '&redirect_uri=https://www.facebook.com/connect/login_success.html&response_type=token&display=touch&scope=' + scope, '_blank', 'location=no');
